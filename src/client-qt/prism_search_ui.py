...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(520, 360, 161, 111))
    ...
    def retranslateUi(self, Form):
        ...
        item.setText(_translate("Form", "item A", None))
        item = self.listWidget.item(1)
        item.setText(_translate("Form", "item B", None))
        item = self.listWidget.item(2)
        item.setText(_translate("Form", "item C", None))
